...
m=function(a){a.stopImmediatePropagation();g&&cancelAnimationFrame(g);g=requestAnimationFrame(function(){const b=n+(a.touches?a.touches[0].clientX:a.clientX),e=k+(a.touches?a.touches[0].clientY:a.clientY);l.style.left=b+"px";l.style.top=e+"px";c.dockMode.drag(a,b)})},q=function(a){h=!0;a.stopImmediatePropagation();if(p){a=l.offsetLeft;const b=l.offsetTop;l.getElementsByClassName("builder_cancel_docked_mode")[0].click();l.style.left=a+"px";l.style.top=b+"px"}e.add("tb_start_animate","tb_move_drag",
...
540>a?b.add("tb_lightbox_small"):b.remove("tb_lightbox_small")}}},fixContainment(){var a=this.$lightbox[0].getBoundingClientRect();const b=a.width,c=window.innerWidth-20,e=window.innerHeight-30,d=a.left;a=a.top;const g={};0>d?g.left=20:d+b>c&&(g.left=c-b);0>a?g.top=0:a>e&&(g.top=e);for(let a in g)this.$lightbox[0].style[a]=g[a]+"px"},setStandAlone(a,b,c){const e=this.$lightbox.outerWidth(),f=this.$lightbox.outerHeight(),g=d.document.documentElement.clientWidth,m=d.document.documentElement.clientHeight;
