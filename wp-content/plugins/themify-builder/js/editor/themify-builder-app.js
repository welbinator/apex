    ...
    'use strict';
        ...
        api.Views.Toolbar = Backbone.View.extend({
            ...
            modChange(e){
                ...
                else if(e.currentTarget.classList.contains('tb_dark_mode')){
                    if(e.currentTarget.checked===true){
        ...
        api.Utils = {
            ...
            saveCss(data,customCss,id){
                return $.ajax({
                    ...
                    cache: false,
                    data: {
                        css: JSON.stringify(api.GS.createCss(data, data[0].mod_name || null, true)),
                        action: 'tb_save_css',
                        custom_css: customCss ,
                        tb_load_nonce: themifyBuilder.tb_load_nonce,
                        id: id
            ...
            changeDarkMode(){
                if(this.darkMode===true){
                    const ui = topWindow.document.createElement('link'),
                        adminui = document.getElementById('themify-builder-admin-ui-css');
                    ui.rel ='stylesheet';
                    ...
                    if(file){
                        file.remove();
                        if(api.mode==='visual'){
                            topWindow.document.getElementById('darkmode-ui').remove();
                        }
                    }
                }
            },
