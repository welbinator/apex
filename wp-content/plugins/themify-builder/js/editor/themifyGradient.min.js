...
d,{passive:!0,once:!0});f.addEventListener(b.mousemove,m,{passive:!0})}},{passive:!0})};this._render=function(){this._initGradientPoints();this._renderCanvas()};this._colorPickerPosition=function(){const a=ThemifyBuilderCommon.Lightbox.$lightbox,b=k.find(".tfminicolors"),c=b.find(".tfminicolors-panel");0<c.length&&(a.offset().left+a.width()<=c.offset().left+c.width()?b.addClass("tb_minicolors_right"):b.removeClass("tb_minicolors_right"))};this._initGradientPoints=function(){const a=f.createDocumentFragment();
...
b.length-1;-1<a;--a)b[a].parentNode.removeChild(b[a]);delete themifyCM.gradients[a]};this.selectSwatch=function(a){a=themifyCM.gradients[a];this.setAngle(a.setting.angle);this.setRadialCircle(a.setting.circle);this.setType(a.setting.type);this.settings.gradient=a.gradient;this.update();var b=n.parentElement;const c=b.getElementsByClassName("themify-gradient-type")[0],d=b.querySelector('input[type="checkbox"]');b=b.getElementsByClassName("tb_angle_input")[0];c.value=a.setting.type;Themify.triggerEvent(c,
