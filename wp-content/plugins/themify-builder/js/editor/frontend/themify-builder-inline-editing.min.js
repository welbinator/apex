...
c.toolbar.find("#tb_editor_lightbox_w,#tb_editor_lightbox_h").val(""));return""!==e}},color:{input:null,is_trigger:!1,result:function(a,b,c){var e=TB_InlineEdit;if(!this.input){a=g('link[href*="jquery.minicolors.css"]',top_iframe).prop("href");Themify.LoadCss(a,!1);n.Utils.setColorPicker(c);this.input=c.find(".tfminicolors-input");var d=this.input.prop("id"),f=this,k=!1;Themify.body.on("themify_builder_color_picker_change",function(a,b,c,g){d!==b||""===g||f.is_trigger||(e.exec("foreColor",g),n.hasChanged=
