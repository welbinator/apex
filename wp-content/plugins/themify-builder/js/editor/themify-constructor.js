    ...
    ThemifyConstructor = {
        ...
        tabs: {
            ...
            render(data, self) {
                ...
                tabs.className = 'tb_tabs';
                    ul.className = 'tf_clearfix tb_tab_wrapper';
                ++this.click;
        ...
        color: {
                ...
                $el.tfminicolors({
                    ...
                    beforeShow() {
                        ...
                        if ((lightbox.offset().left + lightbox.width()) <= panel.offset().left + panel.width()) {
                            p[0].classList.add('tb_tfminicolors_right');
                        }
                        else {
                            p[0].classList.remove('tb_tfminicolors_right');
                        }
            ...
            render(data, self) {
                ...
                swatch.className = 'tfminicolors-swatch';
        ...
        font_select: {
            ...
            updateFontVariant(value, weight, self, type) {
				...
				const field=weight.closest('.tb_field');
                if (this[type][value] === undefined || this[type][value].v === undefined || this[type][value].v.length === 0 ) {
                    field.classList.add('_tb_hide_binding');
                    return;
                }
                ...
                field.classList.remove('_tb_hide_binding');
									...
									termsCallback = function (_cache_key_) {
                                        ...
                                        if(data['all']){
                                            ...
                                            for(let k=els.length-1;k>-1;k--){
                                                if(is_all){
                                                    els[k].classList.add('tf_hide');
                                                }else{
                                                    els[k].classList.remove('tf_hide');
                                                }
                                            }
