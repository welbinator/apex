...
if (!class_exists('Themify_Builder')) :
	...
	function register_deprecated_cpt() {
        ...
        public function wp_loaded() {
            ...
            if(!empty($post_type) && 'on' === themify_builder_get('setting-page_builder_disable_'.$post_type, 'builder_disable_tb_'.$post_type)){
                return;
            }
	...
	public function async_footer() {
		...
		$styles[themify_enque(THEMIFY_METABOX_URI . 'css/themify.minicolors.css')]=THEMIFY_VERSION;
