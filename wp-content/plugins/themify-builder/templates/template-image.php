...
<div <?php echo self::get_element_attributes(self::sticky_element_props($container_props,$fields_args)); ?>>
	...
	<div class="image-content<?php echo $fields_args['style_image']==='image-full-overlay'?' tf_overflow':'';?>">
	    <?php if ($image_title !== ''): ?>
		<<?php echo $fields_args['title_tag'];?> class="image-title"<?php if($fields_args['link_image'] === '' && Themify_Builder::$frontedit_active===true):?> contenteditable="false" data-name="title_image"<?php endif;?>>
		    <?php if ($fields_args['link_image'] !== ''): ?>
