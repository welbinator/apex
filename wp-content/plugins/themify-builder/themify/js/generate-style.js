                ...
                for (let i = 3; i > -1; --i) {
                    switch (options[i]) {
                        ...
                        case 'skew':
                            ...
                            unit='translate'===options[i]?'px':('skew'===options[i]?'deg':'');
                            if('translate'===options[i]){
                                unit={
                                    x:this.getStyleVal(orig_id+'_'+options[i] + '_top_unit', data),
                                    y:this.getStyleVal(orig_id+'_'+options[i] + '_bottom_unit', data)
                                };
                            }else{
