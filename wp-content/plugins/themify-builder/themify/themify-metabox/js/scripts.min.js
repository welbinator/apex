'use strict';jQuery(function(b){var m=function(e,c,a){var d=document.createElement("script");d.type="text/javascript";d.readyState?d.onreadystatechange=function(){if("loaded"==d.readyState||"complete"==d.readyState)d.onreadystatechange=null,a()}:d.onload=function(){a()};var g="type src htmlFor event charset async defer crossOrigin text onerror".split(" ");if("object"==typeof c&&!b.isEmptyObject(c))for(var f in c)c.hasOwnProperty(f)&&b.inArray(f,g)&&(d[f]=c[f]);d.src=e;document.getElementsByTagName(c.lazyLoad?
"body":"head")[0].appendChild(d)};b.loadScript=function(e,c,a){2===arguments.length&&"function"==typeof arguments[1]&&(a=arguments[1],c={});c=c||{};var d=b.Deferred();return"function"==typeof a&&d.done(function(){a()}),m(e,c,function(){d.resolve()}),d.promise()}});
window.Themify_Metabox=function(b){function m(c){var a="";b('input[type="checkbox"]',c).each(function(){a+=b(this).attr("id")+"="+b(this).val()+"&"});b('input[type="text"]',c).val(a.slice(0,-1))}var e={loadScript:function(c,a,d){d?a():b.loadScript(c).done(function(){a()})},init:function(){this.bind_events()},bind_events:function(){b(e.document_ready)},document_ready:function(){e.init_metabox_tabs();e.gallery_shortcode();e.repeater();e.enable_toggle();e.query_category();e.post_meta_checkbox();e.init_fields(b("body"));
e.pagination(b("body"));e.audioRemoveAction();e.builder_page()},init_metabox_tabs:function(){b(".themify-meta-box-tabs").each(function(){var c=b(this),a=b(".ilc-htabs li",c);1<a.length?ilcTabs({ilctabs:"#"+c.attr("id")}):(b(".ilc-tab",c).show(),a.addClass("select"))});b(".ilc-htabs a").on("click",function(){e.set_cookie("themify-builder-tabs",b(this).attr("id"))});"undefined"!=typeof e.get_cookie("themify-builder-tabs")&&null!==e.get_cookie("themify-builder-tabs")&&b("#"+e.get_cookie("themify-builder-tabs")).trigger("click")},
...
"themify_remove_audio";b.post(ajaxurl,c,d)})},color_picker:function(c){"function"===typeof b.fn.tfminicolors&&(c.find(".colorSelectInput").each(function(){var a={},c=b(this).data("format");"rgba"==c?(a.format="rgb",a.opacity=!0):"rgb"==c&&(a.format="rgb");b(this).tfminicolors(a)}),c.find(".clearColor").on("click",function(){b(this).parent().find(".colorSelectInput").tfminicolors("value","");b(this).parent().find(".colorSelectInput").val("")}))},date_picker:function(c){c.find(".themifyDatePicker").each(function(){var a=
...
b('.enable_toggle input[type="checkbox"]:checked').each(function(){var a=b(this).data("val");b(0!=a&&""!==a?"."+a+"-toggle":".default-toggle").show().removeClass("toggled-off")})},query_category:function(){function c(a,b){""!=b?a.closest(".inside").find(".themify_field_row").removeClass("query-field-hide"):a.closest(".inside").find(".themify_field_row").not(a.closest(".themify_field_row")).not(".query-field-visible").addClass("query-field-hide")}var a=b(".themify_field"),d=b(".themify-info-link");
...
function(){var a=b(this);a.prop("checked")?(b(".meta-sub",c).val("yes").prop("disabled",!0).prop("checked",!1).parent().addClass("opacity-7"),a.val("yes")):(b(".meta-sub",c).val("no").prop("disabled",!1).parent().removeClass("opacity-7"),a.val("no"));m(c)});c.on("click",".meta-sub",function(){var a=b(this);a.prop("checked")?a.val("yes"):a.val("no");m(c)})})},pagination:function(c){c.on("click","#themify_assignments_popup_show .themify-popup-visibility-tab",function(a){a.preventDefault();var c=b(this);
...
e).addClass("is-hidden");f.hide();k.append('<div class="tb_slider_loader"></div>')},success:function(a){b(".tb_slider_loader",c).remove();b(".themify-assignment-items-page-"+l,e).removeClass("is-hidden");f.html(a).show()}})})},builder_page:function(){const b=document.getElementById("builder_page");if(b){const a=document.querySelector('#page-options [alt="sidebar-none"]').parentNode,c=document.querySelector('#page-options [alt="full_width"]').parentNode,e=a.closest(".themify_field_row"),f=c.closest(".themify_field_row"),
h=document.getElementById("hide_page_title"),l=h.closest(".themify_field_row"),k=[e,f,l];b.addEventListener("change",function(){if(this.checked){a.click();c.click();for(var b=2;-1<b;b--)k[b].style.opacity=.5,k[b].className+=" disabled";h.value="yes"}else for(b=2;-1<b;b--)k[b].style.opacity=1,k[b].classList.remove("disabled")})}}};e.init();return e}(jQuery);
