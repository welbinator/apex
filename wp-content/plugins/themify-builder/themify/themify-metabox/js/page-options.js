(function ( Themify, document,themify_vars) {
    ...
    window.ThemifyPageOptions = {
        ...
        init(el) {
            ...
            save.addEventListener('click',this.save,{passive:true});
        ...
        save(){
            ThemifyPageOptions.modal.className +=' updating';
            ThemifyPageOptions.loader('show');
            ThemifyPageOptions.fr.contentDocument.querySelector('#post').submit();
        },
        loader(act){
            if('show'===act){
